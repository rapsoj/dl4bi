...
# Gaussian Processes
`python gp.py data=1d kernel=rbf model=tnp_kr seed=7 [wandb=False] [+name="Experiment name"]`

# Bayesian Optimization
`python bayes_opt.py data=1d kernel=rbf model=tnp_kr seed=7 [wandb=False] [+name="Experiment name"]`

# Population Genetics
`python popgen.py model=tnp_kr seed=7 [wandb=False] [+name="Experiment name"]`

# Outbreaks
`python outbreaks.py model=tnp_kr seed=7 [wandb=False] [+name="Experiment name"]`

# MNIST
`python mnist.py model=tnp_kr seed=7 [wandb=False] [+name="Experiment name"]`

# CelebA
`python celeba.py model=tnp_kr seed=7 [wandb=False] [+name="Experiment name"]`
